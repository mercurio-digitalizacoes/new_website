Bem-vindo ao repositório do novo website da Mercúrio Digitalizações, uma empresda especializada em Digitalização de Documentos e implementação de Repositórios Digitais. Nosso principal interesse é em desenvolver e implementar processos para disponibilizar acervos digitalizados em websites acessíveis com busca facilitada, foco nos diferentes tipos de usuários, e visual moderno.

Nosso website está disponível em XXX.
